...
class DataCal(DataTrade):
    ...
    def gen_nuti_data(self) -> pl.DataFrame:
        ...
        df = df.with_columns(
            total_calaries=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("calories"),
            total_fats=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("fats"),
            total_sugars=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("sugars"),
            total_protein=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("protein"),
            total_saturated_fat_g=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("saturated_fat_g"),
            total_cholesterol_mg=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("cholesterol_mg"),
            total_sodium_mg=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("sodium_mg"),
            total_carbohydrate_g=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("carbohydrate_g"),
            total_fiber_g=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("fiber_g"),
            total_sugar_g=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("sugar_g"),
            total_vitamin_d_iu=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("vitamin_d_iu"),
            total_calcium_mg=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("calcium_mg"),
            total_potassium_mg=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("potassium_mg"),
            total_iron_mg=(pl.col("qty_imports") - pl.col("qty_exports")) * pl.col("iron_mg"),
        )
        cols = [
            "total_calaries",
            "total_fats",
